...
import Ingelogdscherm from "./Components/Ingelogdscherm";
    ...
    <NavigationContainer>
      <Stack.Navigator>
        ...
        */}
        <Stack.Screen
          name="Welkom"
          component={Welkomscherm}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="Ebookscherm"
          component={Ebookscherm}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="Mindfullquotesscherm"
          component={Mindfullquotesscherm}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="Personalgoalscherm"
          component={Personalgoalscherm}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="Loginscherm"
          component={Loginscherm}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="Maakaccountscherm"
          component={Maakaccountscherm}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="Dashboard"
