...
export default function Ebookscherm({navigation}){
    const width = Dimensions.get("screen").width;
    const height = Dimensions.get("screen").height;
    console.log("heigth " + 10/height+ " "+ "width "+ 115/width)

    const styles = StyleSheet.create({
        Text1:{alignSelf:"center", position:"relative",color:"#61CBB4",fontSize:50,top:(0.6130208333333333*height),right:(0.04837962962962963*width),zIndex:1,fontWeight:"bold"}
    ...
    return(
    <View>
<Text style={styles.Text1}>Free e-books</Text>
<Text style={styles.Text2}>Find free e-books about financial literacy, Mindfullness</Text>
<Image source={require("../assets/boekenkast.jpg")} style={styles.Image}></Image>
<TouchableOpacity onPress={()=>navigation.navigate("Mindfullquotesscherm")} style={styles.TouchableOpacity}>
