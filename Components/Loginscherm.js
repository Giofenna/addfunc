...
export default function Loginscherm({ navigation }) {
  ...
  const styles = StyleSheet.create({
    ...
    Text1: {
      fontWeight: "bold",
      left: 0.3310185185185185 * width,
      fontSize: 20,
    },
    Image2: {
      aspectRatio: 73 / 15,
      height: 0.06874999999999999 * height,
      left: 0.1273148148148148 * width,
    },
    Textboxtext: {
      left: 0.1273148148148148 * width,
      top: 0.028645833333333332 * height,
      zIndex: 1,
      color: "grey",
    },
    Textinput: {
      ...
      paddingHorizontal: 0.0636574074074074 * width,
    ...
    Buttontext: {
      ...
      fontWeight: "bold",
      zIndex: 1,
      top: 0.5499999999999999 * height,
      left: 0.07638888888888888 * width,
      borderRadius: 15,
      paddingHorizontal: 0.34375 * width,
    ...
    Forgotpassword: {
      color: "#61CBB4",
      left: 0.35648148148148145 * width,
      top: 0.11458333333333333 * height,
    },
    Noaccount: {
      top: 0.31625 * height,
      left: 0.22916666666666666 * width,
      fontWeight: "bold",
    },
    Pressablestyle: {
      top: 0.859375 * height,
      left: 0.611111111111111 * width,
      color: "#61CBB4",
    },
  });
  ...
  return (
    <View style={{ backgroundColor: "white", width: width, height: height }}>
      <Pressable onPress={Keyboard.dismiss}>
        ...
        <Image
          source={require("../assets/myeducationlifestyletext.png")}
          style={styles.Image2}
        ></Image>
        ...
        <TextInput
          onChangeText={(e) => Setwachtwoord(e)}
          style={styles.Textinput}
        ></TextInput>
        <TouchableOpacity
          onPress={() => logIn()}
        ...
        <Pressable
          ...
          onPress={() => navigation.navigate("Maakaccountscherm")}
        >
          <Text style={styles.Pressablestyle}>Sign up!</Text>
        </Pressable>
      </Pressable>
    </View>
  );
